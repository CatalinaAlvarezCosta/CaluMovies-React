...
function ItemDetailContainer () {
    ...
    const promiseDetailProducto= () =>{
        return new Promise ((resolve,reject)=>{
            setTimeout(() => resolve(
              ...
              },
              {
                ...
                subtitulo: 'Los Vengadores restantes deben encontrar una manera de recuperar a sus aliados para un enfrentamiento épico con Thanos, el malvado que diezmó el planeta y el universo.',
                stock: 2,
              ...
              },
              {
                ...
                subtitulo: 'Dos torpes agentes del FBI se hacen pasar por dos chicas de la alta sociedad para investigar una serie de secuestros. No obstante, mientras preparan su plan, descubren que irrumpir en la clase privilegiada es mucho más duro de lo que creían.',
                stock: 6,
              ...
              },
              {
                ...
                subtitulo: 'Ocho años después de asumir la culpa por la muerte de Harvey Dent y desaparecer en la noche, Batman se ve obligado a salir del exilio autoimpuesto gracias a una ladrona astuta y a un terrorista despiadado.',
                stock: 13,
        ...
        useEffect(() =>{
          ...
          const dataFiltradaDetail= detailProducto.filter( element => element.id === idItems)
