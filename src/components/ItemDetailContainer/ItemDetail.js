...
export const ItemDetail = ({detailProducto}) =>{
  const history = useHistory()
    ...
    <div className="fotoDetail"><img src={detailProducto.src} className="fotoDetailImg" alt="FotoDetail"/> </div> 
    <div className="infoDetail">
      ...
      <ItemCount min={1} max={detailProducto.stock} idProducto={detailProducto.id}/>
